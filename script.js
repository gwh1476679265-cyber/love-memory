...
const BIRTHDAY_CINEMA_GROUPS = [
  {
    ...
    captions: [
      ...
      "原来你小时候的神情里，已经有很多现在的影子了。",
      "隔着这些旧照片看你，总觉得这个小朋友也很熟悉。",
      "这一页，是我来晚了很多年才看到的你。",
      "如果能早点认识你，大概也会很想和这个小朋友做朋友。",
      "你的小时候我没参与，但现在很开心能听你慢慢讲给我听。"
    ]
  },
  {
    folder: "youngyun",
    ...
    captions: [
      ...
      "那时候我们各自在自己的生活里，还不知道彼此会出现。",
      "这些年份对我来说原本是空白，现在终于有了你的样子。",
      "看着那时候的你，会忍不住想你当时正在为什么开心。",
      "原来在我认识你以前，你已经这样认真地生活了很多年。",
      "我没有见过那时的你，却越来越喜欢那时的你。"
    ]
  },
  {
    folder: "noguyun",
